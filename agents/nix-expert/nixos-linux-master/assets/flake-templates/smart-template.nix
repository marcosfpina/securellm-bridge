    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        projectType = 
          ...
          else if builtins.pathExists ./package.json then "node"
          else if builtins.pathExists ./go.mod then "go"
          else if builtins.pathExists ./pyproject.toml then "python"
          else "generic";
        ...
        nodeTools = with pkgs; [
          nodejs_20 nodePackages.typescript
          nodePackages.pnpm yarn
        ];
