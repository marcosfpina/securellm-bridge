...
impl Error {
    ...
    pub fn severity(&self) -> ErrorSeverity {
        match self {
            ...
            Error::Provider { .. } | Error::Network(_) | Error::Timeout(_) => ErrorSeverity::High,
            Error::RateLimit(_) | Error::InvalidRequest(_) => ErrorSeverity::Medium,
            Error::Config(_) | Error::ModelNotFound(_) => ErrorSeverity::Low,
